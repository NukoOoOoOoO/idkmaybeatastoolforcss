...
JustAfew: switch ( nBuffer )
    {
        case 7: ulCrc = pulCRCTable[*pb++ ^ static_cast<unsigned char>(ulCrc)] ^ (ulCrc >> 8);

        case 6: ulCrc = pulCRCTable[*pb++ ^ static_cast<unsigned char>(ulCrc)] ^ (ulCrc >> 8);

        case 5: ulCrc = pulCRCTable[*pb++ ^ static_cast<unsigned char>(ulCrc)] ^ (ulCrc >> 8);

        case 4: ulCrc ^= LittleLong( *(CRC32_t*)pb );
        ...
        case 3: ulCrc = pulCRCTable[*pb++ ^ static_cast<unsigned char>(ulCrc)] ^ (ulCrc >> 8);

        case 2: ulCrc = pulCRCTable[*pb++ ^ static_cast<unsigned char>(ulCrc)] ^ (ulCrc >> 8);

        case 1: ulCrc = pulCRCTable[*pb++ ^ static_cast<unsigned char>(ulCrc)] ^ (ulCrc >> 8);
